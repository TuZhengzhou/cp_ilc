...
bool pp_shift<FieldT>::prove() {
    libff::enter_block("pp_shift<FieldT>::prove");
    ...
    libff::leave_block("pp_shift<FieldT>::prove");
...
bool pp_shift<FieldT>::verify(const bool output) const {
    ...
    libff::enter_block("pp_shift<FieldT>::verify()");
    ...
    libff::leave_block("pp_shift<FieldT>::verify()");

    if (left != right) {
        if (output) {
            libff::print_indent(); printf("pp_shift<FieldT>::verify() \033[31mfail\033[37m\n\n");
        }
        return false;
    }
    if (output) {
        libff::print_indent(); printf("pp_shift<FieldT>::verify() \033[32mpass\033[37m\n\n");
    }
    return true;
}
